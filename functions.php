...
function handle_loop_shop_per_page() {
return 6;
}
add_filter('loop_shop_per_page', 'handle_loop_shop_per_page');
...
include(get_template_directory() . '/inc/checkout-custom.php');

include(get_template_directory() . '/inc/email-custom.php');
